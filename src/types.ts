...
export interface ProvidersConfig {
  github?: {
     ...
     *
     * Will read from `SPONSIFY_GITHUB_TOKEN` environment variable if not set.
     *
  ...
  patreon?: {
     ...
     *
     * Will read from `SPONSIFY_PATREON_TOKEN` environment variable if not set.
     *
     * @deprecated It's not recommended set this value directly, pass from env or use `.env` file.
     */
    token?: string;
  ...
  opencollective?: {
     ...
     *
     * Will read from `SPONSIFY_OPENCOLLECTIVE_KEY` environment variable if not set.
     *
     * @deprecated It's not recommended set this value directly, pass from env or use `.env` file.
     */
    key?: string;
  ...
  afdian?: {
     ...
     *
     * Will read from `SPONSIFY_AFDIAN_USER_ID` environment variable if not set.
     *
     ...
     *
     * Will read from `SPONSIFY_AFDIAN_TOKEN` environment variable if not set.
     *
     * @see https://afdian.net/dashboard/dev
     * @deprecated It's not recommended set this value directly, pass from env or use `.env` file.
     */
  ...
  polar?: {
     ...
     *
     * Will read from `SPONSIFY_POLAR_TOKEN` environment variable if not set.
     *
...
export interface SponsifyConfig extends ProvidersConfig, SponsifyRenderOptions {
   ...
   *   [{ login: 'khulnasoft', provider: 'github' }, { login: 'khulnasoft', provider: 'patreon' }],
