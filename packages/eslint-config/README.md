# @khulnasoft/eslint-config

[![npm](https://img.shields.io/npm/v/@khulnasoft/eslint-config?color=444&label=)](https://npmjs.com/package/@khulnasoft/eslint-config) [![code style](https://khulnasoft.me/badge-code-style.svg)](https://github.com/khulnasoft/eslint-config)
...
> [!NOTE]
> Since v1.0.0, this config is rewritten to the new [ESLint Flat config](https://eslint.org/docs/latest/use/configure/configuration-files-new), check the [release note](https://github.com/khulnasoft/eslint-config/releases/tag/v1.0.0) for more details.
>
...
```bash
pnpm dlx @khulnasoft/eslint-config@latest
```
...
```bash
pnpm i -D eslint @khulnasoft/eslint-config
```
...
Normally you only need to import the `khulnasoft` preset:
...
The `khulnasoft` factory function also accepts any number of arbitrary custom config overrides:
...
export default khulnasoft(
  {
    // Configures for khulnasoft's config
  },
...
Check out the [configs](https://github.com/khulnasoft/eslint-config/blob/main/src/configs) and [factory](https://github.com/khulnasoft/eslint-config/blob/main/src/factory.ts) for more details.
...
export default khulnasoft().renamePlugins({
...
Since v2.10.0, the factory function `khulnasoft()` returns a [`FlatConfigComposer` object from `eslint-flat-config-utils`](https://github.com/khulnasoft/eslint-flat-config-utils#composer) where you can chain the methods to compose the config even more flexibly.
...
Use external formatters to format files that ESLint cannot handle yet (`.css`, `.html`, etc). Powered by [`eslint-plugin-format`](https://github.com/khulnasoft/eslint-plugin-format).
...
Powered by [`eslint-plugin-command`](https://github.com/khulnasoft/eslint-plugin-command). It is not a typical rule for linting, but an on-demand micro-codemod tool that triggers by specific comments.
...
- ... etc. - refer to the [documentation](https://github.com/khulnasoft/eslint-plugin-command#built-in-commands)
...
```md
[![code style](https://khulnasoft.me/badge-code-style.svg)](https://github.com/khulnasoft/eslint-config)
```
...
[Why I don't use Prettier](https://khulnasoft.me/posts/why-not-prettier)
...
- [khulnasoft/dotfiles](https://github.com/khulnasoft/dotfiles) - My dotfiles
- [khulnasoft/vscode-settings](https://github.com/khulnasoft/vscode-settings) - My VS Code settings
- [khulnasoft/starter-ts](https://github.com/khulnasoft/starter-ts) - My starter template for TypeScript library
- [khulnasoft/vitesse](https://github.com/khulnasoft/vitesse) - My starter template for Vue & Vite app

## License

[MIT](./LICENSE) License &copy; 2019-PRESENT [Md Sulaiman](https://github.com/khulnasoft)
