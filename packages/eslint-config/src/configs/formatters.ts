...
export async function formatters(
  ...
  const configs: TypedFlatConfigItem[] = [
    {
      name: "khulnasoft/formatter/setup",
      plugins: {
        format: pluginFormat,
      },
    },
  ...
  if (options.css) {
    configs.push(
      ...
      },
      {
        ...
        name: "khulnasoft/formatter/scss",
        rules: {
          "format/prettier": [
            "error",
            mergePrettierOptions(prettierOptions, {
      ...
      },
      {
        ...
        name: "khulnasoft/formatter/less",
        rules: {
          "format/prettier": [
            "error",
            mergePrettierOptions(prettierOptions, {
  ...
  if (options.html) {
    configs.push({
      ...
      name: "khulnasoft/formatter/html",
      rules: {
        "format/prettier": [
          "error",
          mergePrettierOptions(prettierOptions, {
  ...
  if (options.markdown) {
    ...
    configs.push({
      ...
      name: "khulnasoft/formatter/markdown",
      rules: {
        [`format/${formater}`]: [
          "error",
          formater === "prettier"
    ...
    if (options.slidev) {
      configs.push({
        ...
        name: "khulnasoft/formatter/slidev",
        rules: {
          "format/prettier": [
            "error",
            mergePrettierOptions(prettierOptions, {
  ...
  if (options.astro) {
    configs.push({
      ...
      name: "khulnasoft/formatter/astro",
      rules: {
        "format/prettier": [
          "error",
          mergePrettierOptions(prettierOptions, {
    ...
    configs.push({
      ...
      name: "khulnasoft/formatter/astro/disables",
      rules: {
  ...
  if (options.graphql) {
    configs.push({
      ...
      name: "khulnasoft/formatter/graphql",
      rules: {
        "format/prettier": [
          "error",
          mergePrettierOptions(prettierOptions, {
